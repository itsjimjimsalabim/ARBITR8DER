...
def test_auto_trader_uses_snapshot_midpoint_for_edge(monkeypatch, tmp_path):
    ...
    fake_backtest_module = ModuleType("kalshi_desk_package.prediction.backtest_engine")
    ...
    monkeypatch.setitem(sys.modules, "kalshi_desk_package.prediction.backtest_engine", fake_backtest_module)
