...
class TestBaselinePredictionEngine:
    def test_predict_with_valid_features(self) -> None:
        from kalshi_desk_package.prediction.baseline_prediction_engine import BaselinePredictionEngine
        from kalshi_desk_package.prediction.feature_extraction_engine import FeatureExtractionEngine
...
class TestMarketOutcomeResolver:
    def test_parse_settled_yes(self) -> None:
        from kalshi_desk_package.prediction.market_outcome_resolver import MarketOutcomeResolver
    ...
    def test_outcome_to_dict(self) -> None:
        from kalshi_desk_package.prediction.market_outcome_resolver import MarketOutcome, MarketOutcomeResolver
    ...
    def test_resolve_predictions_updates_records(self) -> None:
        ...
        from kalshi_desk_package.prediction.market_outcome_resolver import MarketOutcome
...
class TestPredictionScorer:
    ...
    def test_report_format_human(self) -> None:
        from kalshi_desk_package.prediction.baseline_prediction_engine import PredictionRecord
        from kalshi_desk_package.prediction.prediction_scorer import PredictionScorer, format_report_human
    ...
    def test_report_format_json(self) -> None:
        from kalshi_desk_package.prediction.baseline_prediction_engine import PredictionRecord
        from kalshi_desk_package.prediction.prediction_scorer import PredictionScorer, format_report_json
