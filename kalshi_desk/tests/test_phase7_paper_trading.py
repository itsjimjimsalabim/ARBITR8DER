...
class TestRiskControls:
    ...
    def test_risk_allows_valid_order(self) -> None:
        from kalshi_desk_package.core.risk_controls_module import OrderIntent, RiskController
    ...
    def test_risk_blocks_below_minimum_contracts(self) -> None:
        from kalshi_desk_package.core.risk_controls_module import OrderIntent, RiskController, RiskBlockReason
...
class TestOrderReconciler:
    ...
    def test_format_human(self) -> None:
        from kalshi_desk_package.core.order_reconciliation_module import format_reconciliation_human
...
class TestREPLPhase7Integration:
    ...
    def _mock_orchestrator(self, monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
        ...
        monkeypatch.setattr(
            "kalshi_desk_package.execution.paper_venue_adapter.PaperVenueAdapter.__init__",
            patched_init,
        )
