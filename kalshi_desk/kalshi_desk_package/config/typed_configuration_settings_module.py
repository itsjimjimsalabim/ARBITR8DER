...
the operator ran ``arbitr8der`` from the repo root or from ``kalshi_desk/``.
"""
...
from kalshi_desk_package.config.cwd_independent_path_resolver import get_package_root
...
def _resolve_root_env_file() -> Path | None:
    ...
    """
    package_root = get_package_root()  # .../kalshi_desk
