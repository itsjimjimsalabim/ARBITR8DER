...
class AutoScoringEngine:
    ...
    async def retrain_models(self) -> dict[str, dict]:
        ...
        """
        from arbitr8der_package.prediction.macro_prediction_model import MacroEnsemble
        from arbitr8der_package.prediction.micro_prediction_model import MicroEnsemble
