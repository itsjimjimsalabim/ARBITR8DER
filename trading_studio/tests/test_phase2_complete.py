...
from arbitr8der_package.config.cwd_independent_path_resolver import SQLITE_DB_PATH, get_package_root
...
from arbitr8der_package.durable_storage.bounded_asynchronous_persistence_queue import (
    BoundedPersistenceQueue,
    Priority,
)
from arbitr8der_package.durable_storage.archive_retention_policy_manager import ArchiveRetentionPolicy
...
class TestProviderEventBase:
    def test_provider_event_has_all_lineage_fields(self):
        ...
        from arbitr8der_package.data_contracts.event_data_models import ProviderEvent
...
class TestCWDIndependentPaths:
    ...
    def test_get_package_root_consistent(self):
        assert get_package_root().name == "trading_studio"
