...
class TestStructuredJournal:
    ...
    def test_format_entry_human(self) -> None:
        from arbitr8der_package.cli.structured_trade_journal_module import format_entry_human
    ...
    def test_format_entry_json(self) -> None:
        from arbitr8der_package.cli.structured_trade_journal_module import format_entry_json
...
class TestSessionArchive:
    ...
    def _tmp_archive(self, tmp_path: Path) -> None:
        from arbitr8der_package.cli.session_archive_module import SessionArchive
    ...
    def test_format_archive_summary_human(self) -> None:
        from arbitr8der_package.cli.session_archive_module import format_archive_summary_human
...
class TestScorecard:
    ...
    def test_empty_scorecard(self) -> None:
        from arbitr8der_package.cli.scorecard_module import ScorecardGenerator
    ...
    def test_format_scorecard_human(self) -> None:
        from arbitr8der_package.cli.scorecard_module import ScorecardGenerator, format_scorecard_human
    ...
    def test_format_scorecard_json(self) -> None:
        from arbitr8der_package.cli.scorecard_module import ScorecardGenerator, format_scorecard_json
