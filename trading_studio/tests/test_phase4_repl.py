...
class TestREPLFormatting:
    ...
    def test_format_snapshot_human_with_data(self) -> None:
        from arbitr8der_package.cli.interactive_trading_repl_loop import _format_snapshot_human
    ...
    def test_format_snapshot_json(self) -> None:
        from arbitr8der_package.cli.interactive_trading_repl_loop import _format_snapshot_json
        from arbitr8der_package.data_contracts.event_data_models import Asset, HotSnapshot
...
class TestCLIDocking:
    ...
    def test_forward_start_imports(self) -> None:
        ...
        from arbitr8der_package.cli.cli_application_entrypoint_main import forward_start
