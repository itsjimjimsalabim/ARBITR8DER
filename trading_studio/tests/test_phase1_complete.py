...
from arbitr8der_package.cli.cli_application_entrypoint_main import app
from arbitr8der_package.config.cwd_independent_path_resolver import (
    RUNTIME_DIR,
    RUNTIME_DATA_DIR,
    RUNTIME_LOGS_DIR,
    RUNTIME_STATE_DIR,
...
class TestPathResolver:
    def test_package_root_points_to_trading_studio(self):
        root = get_package_root()
        assert root.name == "trading_studio"
        assert root.is_dir()

    def test_runtime_dirs_are_under_trading_studio(self):
        root = get_package_root()
    ...
    def test_ensure_runtime_dirs_creates_directories(self, tmp_path, monkeypatch):
        import arbitr8der_package.config.cwd_independent_path_resolver as mod
